...
ElementPicker::ElementPicker(int x, int y, int sx, int sy) : HUDobject(x, y, sx, sy, 0) {
    element = 0;
}

int ElementPicker::get_element() {
    return element;
}

void ElementPicker::set_element(int new_element) {
    element = new_element;
}
