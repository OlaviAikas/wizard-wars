                ...
                if (event.mouse.button == 1) {
                    ...
                    switch(e1*e2) {
                        ...
                        case 25: // 5*5 J+J Water+Water = WaterSpray
                            map -> spells.push_back(new WaterSpray((*pit)->get_x() + (*pit)->get_width()/2 + 2*dx*(*pit)->get_width(),(*pit)->get_y() + (*pit)->get_height()/2 + 2*dy*(*pit)->get_height(),dx,dy,map));
                            break;
                        ...
                        case 9:
                            map -> spells.push_back(new FireSpray((*pit)->get_x() + (*pit)->get_width()/2 + 2*dx*(*pit)->get_width(),(*pit)->get_y() + (*pit)->get_height()/2 + 2*dy*(*pit)->get_height(),dx,dy,map));
                            break;
                        default:
